...
def generate_bill(): 
    ...
    quantity=quantityVar.get() 
    cost = costVar.get() 
    conn = pymysql.connect(host="bqgbwrq4bixrboa2oq9z-mysql.services.clever-cloud.com", user="u7ssfu3rhrnex9v6", password="tyK7yF0YpFbStDPZhu4a", db="bqgbwrq4bixrboa2oq9z") 
    cursor = conn.cursor() 
...
def loginWindow(): 
    ...
    titleLabel = Label(window,text="My Bill Book",font=("Arial", 40,'bold' ),fg="green") 
...
def mainwindow(): 
    ...
    titleLabel = Label(window,text="My Bill Book",font="Arial 30",fg="green") 
...
def itemAddWindow(): 
    ...
    titleLabel = Label(window,text="My Bill Book", width=40,font="Arial 30",fg="green") 
